...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--fea_L1', type=float, default=10.0, help='weight for |B-G(A, E(B))|')
        parser.add_argument('--triplet', type=float, default=10.0, help='weight for triplet loss')
        ...
        parser.add_argument('--finetune', type=bool, default=False, help = 'if fine tune or not')
