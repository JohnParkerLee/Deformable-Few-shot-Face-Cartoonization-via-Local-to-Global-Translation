...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--style_data_paths', required=True,
                            help='path to style images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--content_data_paths', required=True,
                            help='path to content images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--part_class', type=str, help='')
        # extra parameters
