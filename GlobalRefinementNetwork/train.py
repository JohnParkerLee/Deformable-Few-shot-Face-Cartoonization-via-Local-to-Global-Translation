...
from model import Discriminator as Rec_Discriminator
...
from e4e.criteria import id_loss as IDLoss
...
@torch.no_grad()
def projection(img, net, return_latents=True, return_features=False):
...
def train(args, loader, generator, discriminator, extra, g_optim, d_optim, e_optim, g_ema,
    ...
    for idx in pbar:
        ...
        if which > 0:
            ...
            # cartoon image -> real people image
